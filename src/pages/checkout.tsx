...
const stripePromise = loadStripe(import.meta.env.VITE_STRIPE_SECRET_KEY as string);
...
const CheckoutForm = () => {
    ...
    const {cartItems,shippingInfo,subtotal,tax,total,shippingCharges,discount}=useSelector((state:RootState)=>state.cartReducer)
